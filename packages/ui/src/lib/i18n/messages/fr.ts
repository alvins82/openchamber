...
export const dict = {
  ...
  'chat.activity.editedFile': 'A modifié un fichier',
  'chat.activity.editedFileFollowing': 'a modifié un fichier',
  'chat.activity.editedFiles': 'Fichiers modifiés',
  'chat.activity.editedFilesFollowing': 'fichiers modifiés',
  'chat.activity.ranCommand': 'A exécuté une commande',
  'chat.activity.ranCommandFollowing': 'a exécuté une commande',
  'chat.activity.ranCommands': 'Commandes exécutées',
  'chat.activity.ranCommandsFollowing': 'commandes exécutées',
  'chat.activity.readFiles': 'A lu des fichiers',
  'chat.activity.readFilesFollowing': 'a lu des fichiers',
  'chat.activity.searchedWeb': 'A effectué une recherche sur le web',
  'chat.activity.searchedWebFollowing': 'a effectué une recherche sur le web',
  'chat.activity.workingFor': 'Travail en cours depuis {duration}',
  'chat.activity.working': 'En cours...',
  'chat.activity.workedFor': 'A travaillé pendant {duration}',
  'chat.activity.worked': 'A travaillé',
