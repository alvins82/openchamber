...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.activity.editedFile': '已編輯檔案',
  'chat.activity.editedFileFollowing': '已編輯檔案',
  'chat.activity.editedFiles': '已編輯檔案',
  'chat.activity.editedFilesFollowing': '已編輯檔案',
  'chat.activity.ranCommand': '已執行命令',
  'chat.activity.ranCommandFollowing': '已執行命令',
  'chat.activity.ranCommands': '已執行命令',
  'chat.activity.ranCommandsFollowing': '已執行命令',
  'chat.activity.readFiles': '已讀取檔案',
  'chat.activity.readFilesFollowing': '已讀取檔案',
  'chat.activity.searchedWeb': '已搜尋網頁',
  'chat.activity.searchedWebFollowing': '已搜尋網頁',
