...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.activity.editedFile': 'ファイルを編集しました',
  'chat.activity.editedFileFollowing': 'ファイルを編集しました',
  'chat.activity.editedFiles': 'ファイルを編集しました',
  'chat.activity.editedFilesFollowing': 'ファイルを編集しました',
  'chat.activity.ranCommand': 'コマンドを実行しました',
  'chat.activity.ranCommandFollowing': 'コマンドを実行しました',
  'chat.activity.ranCommands': 'コマンドを実行しました',
  'chat.activity.ranCommandsFollowing': 'コマンドを実行しました',
  'chat.activity.readFiles': 'ファイルを読みました',
  'chat.activity.readFilesFollowing': 'ファイルを読みました',
  'chat.activity.searchedWeb': 'ウェブを検索しました',
  'chat.activity.searchedWebFollowing': 'ウェブを検索しました',
  'chat.activity.workingFor': '{duration} 作業中',
  'chat.activity.working': '作業中...',
  'chat.activity.workedFor': '{duration} 作業しました',
  'chat.activity.worked': '作業しました',
