...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.activity.editedFile': '编辑了文件',
  'chat.activity.editedFileFollowing': '编辑了文件',
  'chat.activity.editedFiles': '编辑了文件',
  'chat.activity.editedFilesFollowing': '编辑了文件',
  'chat.activity.ranCommand': '运行了命令',
  'chat.activity.ranCommandFollowing': '运行了命令',
  'chat.activity.ranCommands': '运行了命令',
  'chat.activity.ranCommandsFollowing': '运行了命令',
  'chat.activity.readFiles': '读取了文件',
  'chat.activity.readFilesFollowing': '读取了文件',
  'chat.activity.searchedWeb': '搜索了网页',
  'chat.activity.searchedWebFollowing': '搜索了网页',
  'chat.activity.workingFor': '已工作 {duration}',
  'chat.activity.working': '工作中...',
  'chat.activity.workedFor': '已工作 {duration}',
  'chat.activity.worked': '已完成工作',
