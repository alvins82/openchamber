...
export const dict = {
  ...
  'chat.activity.editedFile': 'Edited a file',
  'chat.activity.editedFileFollowing': 'edited a file',
  'chat.activity.editedFiles': 'Edited files',
  'chat.activity.editedFilesFollowing': 'edited files',
  'chat.activity.ranCommand': 'Ran a command',
  'chat.activity.ranCommandFollowing': 'ran a command',
  'chat.activity.ranCommands': 'Ran commands',
  'chat.activity.ranCommandsFollowing': 'ran commands',
  'chat.activity.readFiles': 'Read files',
  'chat.activity.readFilesFollowing': 'read files',
  'chat.activity.searchedWeb': 'Searched the web',
  'chat.activity.searchedWebFollowing': 'searched the web',
  'chat.activity.workingFor': 'Working for {duration}',
  'chat.activity.working': 'Working...',
  'chat.activity.workedFor': 'Worked for {duration}',
  'chat.activity.worked': 'Worked',
