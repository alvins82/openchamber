...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.activity.editedFile": "Editó un archivo",
  "chat.activity.editedFileFollowing": "editó un archivo",
  "chat.activity.editedFiles": "Archivos editados",
  "chat.activity.editedFilesFollowing": "archivos editados",
  "chat.activity.ranCommand": "Ejecutó un comando",
  "chat.activity.ranCommandFollowing": "ejecutó un comando",
  "chat.activity.ranCommands": "Comandos ejecutados",
  "chat.activity.ranCommandsFollowing": "comandos ejecutados",
  "chat.activity.readFiles": "Leyó archivos",
  "chat.activity.readFilesFollowing": "leyó archivos",
  "chat.activity.searchedWeb": "Buscó en la web",
  "chat.activity.searchedWebFollowing": "buscó en la web",
  "chat.activity.workingFor": "Trabajando durante {duration}",
  "chat.activity.working": "Trabajando...",
  "chat.activity.workedFor": "Trabajó durante {duration}",
  "chat.activity.worked": "Trabajó",
