...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.activity.editedFile': '파일을 편집함',
  'chat.activity.editedFileFollowing': '파일을 편집함',
  'chat.activity.editedFiles': '파일을 편집함',
  'chat.activity.editedFilesFollowing': '파일을 편집함',
  'chat.activity.ranCommand': '명령 실행함',
  'chat.activity.ranCommandFollowing': '명령 실행함',
  'chat.activity.ranCommands': '명령 실행함',
  'chat.activity.ranCommandsFollowing': '명령 실행함',
  'chat.activity.readFiles': '파일을 읽음',
  'chat.activity.readFilesFollowing': '파일을 읽음',
  'chat.activity.searchedWeb': '웹 검색함',
  'chat.activity.searchedWebFollowing': '웹 검색함',
  'chat.activity.workingFor': '{duration} 동안 작업 중',
  'chat.activity.working': '작업 중...',
  'chat.activity.workedFor': '{duration} 동안 작업함',
  'chat.activity.worked': '작업 완료',
