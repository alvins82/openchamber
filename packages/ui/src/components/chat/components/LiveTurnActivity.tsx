...
import { LiveFinalActivityContext, LiveTurnActivityContext } from './liveActivityContext';
...
export function LiveTurnActivity({ turn, hasLaterAssistant, expanded, onToggle, renderMessage }: LiveTurnActivityProps) {
    ...
    const finalContext = React.useMemo(() => finalMessage ? {
        messageId: finalMessage.info.id,
        expanded: isExpanded,
        contentId: finalContentId,
        animateCollapse: animateFinalCollapse,
    ...
    return (
        <LiveTurnActivityContext.Provider value={isExpanded}>
